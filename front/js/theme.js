...
theme_obj={
  ...
  'theme2':{
    'html':'<h1>Animation</h1><p>some animation demo</p><div class="outer_point" id="p1"> <div class="point"> <div class="inner_point"> </div></div></div><div class="outer_point" id="p2"> <div class="point"> <div class="inner_point"> </div></div></div>',
  ...
  target.addEventListener('click',function(){
    ...
    for(j=0;j<slides.length;j++){
      for(k=theme_elms.length-1;k+1;k--){
        ...
        if(['P','H1','H2'].includes(elm.tagName)){
